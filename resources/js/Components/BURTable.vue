...
const documents = ref([
{
  subject: 'Juan Dela Cruz',        // Payee
  description: 'Office Supplies',   // Particulars
  amount: 15000,                    // Amount
  dateReleased: '2025-07-03',       // Date Released
  chequeDate: '2025-07-04',         // Cheque Date
  file: 'receipt.pdf',
  fileUrl: '...',
...
<table class="bg-white border border-gray-300 text-sm w-full">
  <thead class="bg-gray-100">
    <tr>
      <th class="border px-4 py-2 text-left align-top whitespace-normal">Payee</th>
      <th class="border px-4 py-2 text-left align-top whitespace-normal">Particulars</th>
      <th class="border px-4 py-2 text-left align-top whitespace-normal">Amount</th>
      <th class="border px-4 py-2 text-left align-top whitespace-normal">Date Released</th>
      <th class="border px-4 py-2 text-left align-top whitespace-normal">Cheque Date</th>
  ...
  <tbody>
    <tr v-for="(doc, index) in filteredDocuments" :key="index">
      ...
      <td class="border px-4 py-2 align-top whitespace-normal">
        <input v-model="doc.amount" type="number" class="w-full bg-transparent" />
      </td>
      <td class="border px-4 py-2 align-top whitespace-normal">
        <input v-model="doc.dateReleased" type="date" class="w-full bg-transparent" />
      </td>
      <td class="border px-4 py-2 align-top whitespace-normal">
        <input v-model="doc.chequeDate" type="date" class="w-full bg-transparent" />
      </td>
      <td class="border px-4 py-2 align-top whitespace-normal">
